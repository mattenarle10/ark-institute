        ...
        <div className="grid gap-6 md:gap-8 md:grid-cols-2">
          ...
          <div data-reveal className="rounded-2xl bg-white p-5 md:p-6 shadow-sm ring-1 ring-black/5 transition-all duration-200 hover:shadow-md hover:-translate-y-[1px]">
            <div className="mb-4 flex items-center">
              ...
              <h3 className="font-montserrat text-lg sm:text-xl font-bold tracking-tight text-gray-900">Our Mission</h3>
            </div>
          ...
          <div data-reveal className="rounded-2xl bg-white p-5 md:p-6 shadow-sm ring-1 ring-black/5 transition-all duration-200 hover:shadow-md hover:-translate-y-[1px]">
            <div className="mb-4 flex items-center">
              ...
              <h3 className="font-montserrat text-lg sm:text-xl font-bold tracking-tight text-gray-900">Our Vision</h3>
            </div>
            <p className="text-sm sm:text-base leading-relaxed text-gray-700">
