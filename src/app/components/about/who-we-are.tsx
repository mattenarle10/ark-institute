    ...
    <section ref={sectionRef} className="bg-white py-16">
      <div className="mx-auto max-w-6xl px-6 sm:px-8 md:px-16">
        <div className="mb-6 text-left md:text-center">
          <h2 data-reveal className="font-montserrat text-xl sm:text-2xl md:text-3xl font-extrabold tracking-tight text-gray-900 text-shadow-md">Who we are</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-10 items-center">
          ...
          <div className="md:col-span-5">
            <div data-reveal className="relative w-full overflow-hidden rounded-2xl bg-white p-1.5 md:p-2 ring-1 ring-black/5 shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-[1px]">
              <Image
