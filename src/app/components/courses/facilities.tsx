...
const facilities = [
  ...
  },
  {
    ...
    description:
      "Hotel, BnB rooms for practicing professional housekeeping and room management skills.",
    images: [
...
export default function Facilities() {
  const sectionRef = useScrollReveal({ delay: 0.05 })
    ...
    <section ref={sectionRef} className="py-12 sm:py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-6 sm:px-8 md:px-16">
        <div className="mb-8 sm:mb-12">
          ...
          >
            Designed to simulate real workplace environments, our facilities
            provide the ideal setting for practical, hands-on learning.
          </p>
        </div>
        ...
        <div className="space-y-12 sm:space-y-16">
          {facilities.map((facility, index) => (
            <div
              data-reveal
              key={facility.id}
              className={`facility-item flex flex-col ${index % 2 === 1 ? "md:flex-row-reverse" : "md:flex-row"} gap-6 md:gap-10 items-center`}
            >
              ...
              <div className="w-full md:w-1/2 space-y-4">
                <h3 className="text-xl font-semibold text-gray-900 text-shadow-sm">
                  {facility.title}
                </h3>
