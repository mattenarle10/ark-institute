      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 sm:px-8 md:px-16 py-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-start">
          ...
          <div className="md:col-span-5 lg:col-span-5">
            <div className="space-y-4">
              ...
              <p className="text-white/80 text-sm leading-relaxed max-w-md">
                TESDA‑accredited training for real skills and real
                opportunities.
              </p>
              <div className="flex items-center justify-start gap-3">
                <a
                  href="https://www.facebook.com/people/ARK-Institute-Inc/61572338462118/?_rdc=1&_rdr"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-white/5 ring-1 ring-white/10 hover:bg-white/10 hover:ring-white/20 transition"
                >
                ...
                <a
                  href="https://www.instagram.com/arkinstitutebc/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-white/5 ring-1 ring-white/10 hover:bg-white/10 hover:ring-white/20 transition"
                >
          ...
          <div className="md:col-span-4 lg:col-span-4">
            ...
            <ul className="mt-4 space-y-3 text-sm text-white/85 max-w-sm">
              <li className="flex items-start justify-start gap-2">
                <svg
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4 mt-0.5 text-white/70"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
                    fillRule="evenodd"
                    d="M10.076 2.004a.75.75 0 00-.152 0A7.5 7.5 0 002.5 9.5c0 2.544 1.318 4.62 2.707 6.09a20.1 20.1 0 003.862 3.082.75.75 0 00.862 0 20.1 20.1 0 003.862-3.081C16.182 14.12 17.5 12.044 17.5 9.5a7.5 7.5 0 00-7.424-7.496zM10 11.5a2 2 0 100-4 2 2 0 000 4z"
                    clipRule="evenodd"
                  />
                </svg>
                <span className="break-words">
                  RGE Building, Victorina Heights Subdivision, Brgy.
                  Mansilingan, Bacolod City, Negros Occidental 6100, Philippines
                </span>
              </li>
              <li className="flex items-center justify-start gap-2">
                ...
                <a
                  href="mailto:info@arkinstitutebc.com"
        ...
        {/* Bottom bar */}
        <div className="mt-10 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-start sm:justify-between gap-2 sm:gap-3 text-xs sm:text-sm text-white/70">
