...
export default function CTA() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const animateIn = (el: Element | null) => {
        if (!el) return;
        const from = reduce ? { opacity: 0 } : { opacity: 0, y: 16, filter: 'blur(8px)' } as gsap.TweenVars;
        const to = reduce
          ? { opacity: 1, duration: 0.3, ease: 'power1.out', scrollTrigger: { trigger: el, start: 'top 90%', toggleActions: 'play none none none' } }
          : { opacity: 1, y: 0, filter: 'blur(0px)', duration: 0.6, ease: 'power2.out', scrollTrigger: { trigger: el, start: 'top 85%', toggleActions: 'play none none none' } };
  ...
  return (
    ...
    >
      ...
      <div ref={bgLinesRef} className="hidden md:block pointer-events-none absolute inset-0 z-10">
      ...
      <div className="relative z-20 mx-auto max-w-7xl px-6 sm:px-8 md:px-16">
        <div className="grid md:grid-cols-12 gap-8 md:gap-12 items-center">
          ...
          <div className="md:col-span-6 lg:col-span-7" ref={textRef}>
            ...
            <p ref={descRef} className="mt-6 text-lg md:text-xl text-gray-700 leading-relaxed max-w-2xl">
              Hands‑on programs designed by experienced instructors to prepare you for work.
            </p>
            
            {/* Course categories: show only Registered */}
            <div ref={chipsRef} className="mt-6 md:mt-8 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 max-w-lg">
              <div className="flex items-center gap-3 rounded-lg px-2 py-1.5">
                ...
                <span className="text-[13px] sm:text-sm font-medium text-gray-800 leading-tight tracking-tight">Housekeeping NC II</span>
              </div>
              <div className="flex items-center gap-3 rounded-lg px-2 py-1.5">
                ...
                <span className="text-[13px] sm:text-sm font-medium text-gray-800 leading-tight tracking-tight">Food and Beverage Services NC II</span>
              </div>
            </div>
          </div>

          {/* Right: CTA buttons with image-backed tiles */}
          <div className="md:col-span-6 lg:col-span-5 mt-10 md:mt-0" ref={buttonsRef}>
            <div className="flex flex-col gap-4 md:items-stretch">
              ...
              >
                <div
                  ...
                  style={{ backgroundImage: "url('/images/housekeep-1.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}
                >
                ...
                <div className="relative pl-32 sm:pl-36 pr-4 py-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm sm:text-lg font-semibold text-gray-800 whitespace-nowrap">Explore Courses</span>
                  </div>
              ...
              >
                <div
                  className="tile-media absolute inset-y-0 left-0 w-28 sm:w-32 overflow-hidden pointer-events-none"
                  style={{ backgroundImage: "url('/images/brainstorm.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}
                >
                  <div className="absolute -inset-2 sm:-inset-3">
                    <Image
                ...
                <div className="relative pl-32 sm:pl-36 pr-4 py-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm sm:text-lg font-semibold text-gray-800 whitespace-nowrap">Request Information</span>
                  </div>
